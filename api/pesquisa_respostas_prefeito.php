...
// Gate: apenas Prefeito/Admin Público (perfil 2)
...
<head>
  <meta charset="UTF-8" />
  <title>Respostas de Pesquisas (Prefeito) - RADCI</title>
  ...
  <header class="bg-green-700 text-white">
    <div class="container mx-auto px-6 py-4 flex items-center justify-between relative">
      ...
      <nav class="hidden md:flex items-center gap-6">
        ...
        <a href="pesquisa_respostas_prefeito.php" class="hover:underline font-semibold">Respostas</a>
      ...
      <div id="mobileMenu" class="absolute right-6 top-14 md:hidden hidden bg-white text-gray-800 rounded-lg shadow-lg border w-56">
        ...
        <a href="pesquisa_respostas_prefeito.php" class="block px-4 py-2 hover:bg-gray-100 font-semibold">Respostas</a>
